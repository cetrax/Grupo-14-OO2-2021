...
INSERT INTO `local` (id_local,direccion,latitud,longitud,stock_cantidad,telefono) VALUES(1,"Alto Avellaneda Shopping, Gral. Güemes 897",3.15,1,0,"1111111111");
INSERT INTO `local` (direccion,latitud,longitud,stock_cantidad,telefono) VALUES("Abasto Shopping, Av. Corrientes 3247",-3.15,1,0,"2222222222");
INSERT INTO `local` (direccion,latitud,longitud,stock_cantidad,telefono) VALUES("Nike Factory Store, Av. Pres. Hipólito Yrigoyen 9272",6.35,2.423,0,"3333333333");
INSERT INTO `local` (direccion,latitud,longitud,stock_cantidad,telefono) VALUES("Paseo Alcorta Shopping, Jerónimo Salguero 3172",3.145,2.1,0,"4444444444");
INSERT INTO `local` (direccion,latitud,longitud,stock_cantidad,telefono) VALUES("Nike Soho, Gurruchaga 1615",3.23,1.9,0,"5555555555");
...
INSERT INTO empleado (id_persona,franja_horaria,es_gerente) VALUES(1,"de 09:30 a 17:30",false);
INSERT INTO cliente (id_persona,email) VALUES(2,"nlopez@gmail.com");
INSERT INTO empleado (id_persona,franja_horaria,es_gerente) VALUES(3,"de 09:30 a 17:30",true);
